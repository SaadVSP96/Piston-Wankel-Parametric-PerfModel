...
mach = [0.01, 0.05, 0.1, 0.12, 0.15, 0.18, 0.20, 0.21, 0.25 ,0.3];
...
for i = 1:1:length(altitudes)
    ...
    for j=1:1:length(power_settings)
        ...
        p = polyfit(mach, thrust_pounds_feet_per_second(:, i, j)', 6);
        thrust_pounds_feet_per_second_new(:, i, j) = polyval(p,mach_new);
...
thrust_surface_PS_20(:,:) = thrust_pounds_feet_per_second(:,:,1);
thrust_surface_PS_25(:,:) = thrust_pounds_feet_per_second(:,:,2);
thrust_surface_PS_30(:,:) = thrust_pounds_feet_per_second(:,:,3);
thrust_surface_PS_40(:,:) = thrust_pounds_feet_per_second(:,:,4);
thrust_surface_PS_50(:,:) = thrust_pounds_feet_per_second(:,:,5);
thrust_surface_PS_70(:,:) = thrust_pounds_feet_per_second(:,:,6);
thrust_surface_PS_100(:,:) = thrust_pounds_feet_per_second(:,:,7);
