...
eeta_p = J*(C_T/C_P);
%Saving file with corrections
file_name_1 = strcat('alt_',num2str(altitude_ft),'_V_',num2str(V_0_fts),'_RPM_',num2str(RPM),'_With_Corr');
path_1 = 'E:\NAQCODE Project 14 - SAMI RFQ\Engine_Propeller_Model_BEMT_and_Engine_Arrays_Deck_Build\Results_of_22x8_APC_Prop_with_corrections';
save(strcat(path_1,'\',file_name_1))
...
J = V_0_fts/(n*(Dia_prop/12));
eeta_p = J*(C_T/C_P);
%Saving file without corrections
file_name_2 = strcat('alt_',num2str(altitude_ft),'_V_',num2str(V_0_fts),'_RPM_',num2str(RPM),'_Without_Corr');
path_2 = 'E:\NAQCODE Project 14 - SAMI RFQ\Engine_Propeller_Model_BEMT_and_Engine_Arrays_Deck_Build\Results_of_22x8_APC_Prop_w_o_corrections';
save(strcat(path_2,'\',file_name_2))
