...
plot(x,c_by_R,'c','LineWidth',2)
xlabel('segment location - r/R');ylabel('c/R');grid on
title('Segment Chord Distribution along Blade')

figure()
plot(x,Beta_deg,'g','LineWidth',2)
xlabel('segment location - r/R');ylabel('Beta (pitch angle) - deg');grid on
title('Segment Pitch Angle Distribution along Blade')


%Plot output characteristics
figure()
plot(x,C_l(:,end),'r','LineWidth',2)
xlabel('segment location - r/R');ylabel('lift coeff - C_l');grid on
title('Segment Lift Coefficient along Blade')

figure()
plot(x,C_d(:,end),'g','LineWidth',2)
xlabel('segment location - r/R');ylabel('drag coeff - C_d');grid on
title('Segment Drag Coefficient along Blade')

figure()
plot(x,d_T,'b','LineWidth',2)
xlabel('segment location - r/R');ylabel('segment thrust - lb_f');grid on
title('Segment Thrust along Blade')

figure()
plot(x,d_P,'k','LineWidth',2)
